...
|---|--:|--:|--:|--:|
| MedPsy-4B (Q4_K_M) | 34/36 | 112 | 277 | 9716 |
| MedGemma 4B IT (Q4_1) | 30/36 | 74 | 0 | 1465 |
...
|---|---|--:|--:|--:|--:|:--:|:--|
| How do I treat severe bleeding? | MedPsy-4B (Q4_K_M) | 88 | 313 | 33.4 | 13440 | 4/4 | gpu |
| What should I do for a burn? | MedPsy-4B (Q4_K_M) | 123 | 216 | 33.9 | 11501 | 3/4 | gpu |
| How do I help an adult who is choking? | MedPsy-4B (Q4_K_M) | 193 | 298 | 34.2 | 15840 | 2/3 | gpu |
| What is the RICE method for a sprain? | MedPsy-4B (Q4_K_M) | 49 | 238 | 32.5 | 9894 | 4/4 | gpu |
| How do I treat heat stroke? | MedPsy-4B (Q4_K_M) | 118 | 301 | 34.4 | 13825 | 4/4 | gpu |
| What are the signs of shock and what should I do? | MedPsy-4B (Q4_K_M) | 133 | 344 | 33.8 | 15434 | 4/4 | gpu |
| How do I respond to anaphylaxis? | MedPsy-4B (Q4_K_M) | 154 | 294 | 33.2 | 14828 | 3/3 | gpu |
| What should I do if someone is unresponsive and not breathing? | MedPsy-4B (Q4_K_M) | 117 | 279 | 34.1 | 13021 | 4/4 | gpu |
| How do I care for a suspected broken bone? | MedPsy-4B (Q4_K_M) | 82 | 260 | 32.5 | 12002 | 3/3 | gpu |
| Should I use ice or butter on a burn? | MedPsy-4B (Q4_K_M) | 61 | 229 | 31.8 | 10688 | 3/3 | gpu |
| How do I treat severe bleeding? | MedGemma 4B IT (Q4_1) | 30 | 0 | 33.1 | 2120 | 1/4 | gpu |
| What should I do for a burn? | MedGemma 4B IT (Q4_1) | 123 | 0 | 33.0 | 5046 | 3/4 | gpu |
| How do I help an adult who is choking? | MedGemma 4B IT (Q4_1) | 131 | 0 | 33.3 | 5345 | 3/3 | gpu |
| What is the RICE method for a sprain? | MedGemma 4B IT (Q4_1) | 45 | 0 | 34.3 | 2726 | 4/4 | gpu |
| How do I treat heat stroke? | MedGemma 4B IT (Q4_1) | 95 | 0 | 33.6 | 4641 | 4/4 | gpu |
| What are the signs of shock and what should I do? | MedGemma 4B IT (Q4_1) | 74 | 0 | 30.5 | 3842 | 4/4 | gpu |
| How do I respond to anaphylaxis? | MedGemma 4B IT (Q4_1) | 82 | 0 | 32.5 | 4037 | 3/3 | gpu |
| What should I do if someone is unresponsive and not breathing? | MedGemma 4B IT (Q4_1) | 107 | 0 | 31.9 | 4872 | 4/4 | gpu |
| How do I care for a suspected broken bone? | MedGemma 4B IT (Q4_1) | 32 | 0 | 31.7 | 2426 | 3/3 | gpu |
| Should I use ice or butter on a burn? | MedGemma 4B IT (Q4_1) | 17 | 0 | 33.7 | 2123 | 1/3 | gpu |

## Answers (qualitative)

### How do I treat severe bleeding?

**MedPsy-4B (Q4_K_M)** — facts 4/4:
...
**MedGemma 4B IT (Q4_1)** — facts 1/4:  _(missed: tourniquet, do not remove, emergency)_
...
**MedPsy-4B (Q4_K_M)** — facts 3/4:  _(missed: 20 minutes)_
...
**MedGemma 4B IT (Q4_1)** — facts 3/4:  _(missed: 20 minutes)_
...
**MedPsy-4B (Q4_K_M)** — facts 2/3:  _(missed: five)_
...
**MedGemma 4B IT (Q4_1)** — facts 1/3:  _(missed: cool, water)_
