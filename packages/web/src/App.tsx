...
export function App() {
  ...
  return (
    <div className="flex h-dvh flex-col bg-base text-fg">
      <Header onSettings={() => setSettingsOpen(true)} onAbout={() => setAboutOpen(true)} onMesh={() => setTool("network")} />
      ...
      <div className="flex min-h-0 flex-1">
        ...
        {/* On the conversation, the mesh stays a persistent live showpiece on wide
            screens — unchanged from before. The Network tool gives it a full home. */}
        {active.id === "converse" && (
